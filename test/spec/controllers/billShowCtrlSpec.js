...
(function() {
  ...
  describe('Bill Controller: Show (BillShowCtrl)', function() {
    ...
    beforeEach(inject(function(_$controller_, _$rootScope_) {
      var BillShowCtrl;
      scope = _$rootScope_;
      return BillShowCtrl = _$controller_('BillShowCtrl', {
        $scope: scope,
        $routeParams: {
          id: 1
        }
    ...
    return describe('GET bills#show', function() {
      var mockBill;
      mockBill = null;
      ...
      return it('returns a list of bills', function() {
        return expect(scope.bill).toEqual(JSON.parse(mockBill));
      });
    });
  });
...
/*
//@ sourceMappingURL=billShowCtrlSpec.map
*/
