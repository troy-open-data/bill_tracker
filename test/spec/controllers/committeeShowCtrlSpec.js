...
describe('Committee Controller: Show (CommitteeShowCtrl)', function() {
  ...
  describe('GET committees#show', function() {
    var httpBackend, mockCommittee, hostUrl;
    ...
    beforeEach(inject(function(_$httpBackend_) {
      ...
      httpBackend.expectGET(hostUrl + '/organizations/1')
        .respond(200, mockCommittee);
      httpBackend.flush();
    }));

    it('returns a list of committees', function() {
