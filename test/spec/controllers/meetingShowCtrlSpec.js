...
(function() {
  ...
  describe('Meeting Controller: Show (MeetingShowCtrl)', function() {
    ...
    beforeEach(inject(function(_$controller_, _$rootScope_) {
      var MeetingShowCtrl;
      scope = _$rootScope_;
      return MeetingShowCtrl = _$controller_('MeetingShowCtrl', {
        $scope: scope,
        $routeParams: {
          id: 1
        }
    ...
    return describe('GET meetings#show', function() {
      var mockMeeting;
      mockMeeting = null;
      ...
      return it('returns a list of meetings', function() {
        return expect(scope.meeting).toEqual(JSON.parse(mockMeeting));
      });
    });
  });
...
/*
//@ sourceMappingURL=meetingShowCtrlSpec.map
*/
