...
describe('Meeting Controller: Show (MeetingShowCtrl)', function() {
  ...
  describe('GET meetings#show', function() {
    var httpBackend, mockMeeting, hostUrl;
    ...
    beforeEach(inject(function(_$httpBackend_) {
      ...
      httpBackend.expectGET(hostUrl + '/meetings/1')
        .respond(200, mockMeeting);
      httpBackend.flush();
    }));

    it('returns a list of meetings', function() {
