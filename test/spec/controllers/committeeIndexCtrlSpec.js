...
describe('Committee Controller: Index (CommitteeIndexCtrl)', function() {
  ...
  describe('GET committees#all', function() {
    var httpBackend, mockCommittees, hostUrl;
    ...
    beforeEach(inject(function(_$httpBackend_) {
      ...
      httpBackend.expectGET(hostUrl + '/organizations')
        .respond(200, mockCommittees);
      httpBackend.flush();
    }));
